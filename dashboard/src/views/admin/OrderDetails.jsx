        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4 bg-[#6a5fdf] rounded-md'>
                <div className='flex justify-between items-center p-4'>
                    ...
                    <select name="" id="" className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#475569]
                     border-slate-700 rounded-md text-[#d0d2d6]'>
                        <option value="">pending</option>
                        <option value="">processing</option>
                        <option value="">warhouse</option>
                        ...
                        <div className='w-[30%]'>
                            <div className='pr-3 text-[#d0d2d6] text-lg'>
                                <div className='flex flex-col gap-1'>
                                    ...
                                    <p><span className='text-sm'>Cecilia ChapmanNulla St.Mankato Miss</span></p>
                                </div>
                                ...
                                <div className='mt-4 flex flex-col gap-4 bg-[#8288ed] rounded-md'>
                                    <div className='text-[#d0d2d6]'>
                                        <div className='flex gap-3 text-md'>
                                            ...
                                            <div>
                                                <h2>Product Namee here</h2>
                                                <p>
                                                    <span>Brand : </span>
                                                    <span>Easy</span>
                                                    <span className='text'>Quantity : 3 </span>
                                                </p>
                                            </div>
