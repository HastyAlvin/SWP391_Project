                                ...
                                <tbody>
                                    {
                                        [1, 2, 3, 4, 5].map((d, i) => <tr key={i}>
                                            ...
                                            <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>Tshirt</td>
                        ...
                        <div className='bg-[#6a5fdf] h-screen lg:h-auto px-3 py-2 lg:rounded-md text-[#d0d2d6]'>
                            ...
                            <form >
                                <div className='flex flex-col w-full gap-1 mb-3'>
                                    ...
                                    <input className='px-4 py-2 focus:border-indigo-500 outline-none
                                     bg-[#ffffff] border border-slate-700 rounded-md text-[#000000]' type="text" id='name' name='category_name' placeholder='Category Name' />
                                </div>
                                ...
                                <div>
                                    ...
                                    <div>
                                        <button className='bg-red-500 w-full hover:shadow-red-300/50 hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>Add Category</button>
                                    </div>
                                </div>
                            </form>
                        </div>
